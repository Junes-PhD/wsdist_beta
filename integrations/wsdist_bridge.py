...
from data import gear as gear_pyfile
...
EXACT_RANK_AUGMENTS = {
    ...
    ("kikoku", "A", 2): {"DMG": 1, "Blade: Metsu Damage": 2},
    ("crocea mors", "C", 17): {
        "DMG": 5, "Elemental WS Damage%": 60, "EnSpell Damage%": 340,
    },
    ("akademos", "A", 15): {"MP": 80, "INT": 20, "Magic Attack": 20},
    ("akademos", "C", 15): {"INT": 15, "Magic Attack": 15, "Magic Accuracy": 15},
    ("bagua charm +1", "A", 1): {"MP": 1},
    ("bagua charm +1", "A", 5): {"MP": 10},
    ("bard's charm +1", "A", 1): {"DEX": 1, "CHR": 1, "PDL": 1},
    ("cabal. sword", "C", 9): {"HP": 90, "Cure Potency": 9, "Refresh": 1},
    ("carmine fin. ga. +1", "D", 15): {"Ranged Attack": 20, "Magic Attack": 12, "Store TP": 6},
    ("annihilator", "A", 7): {"DMG": 4},
    ("bihu knife", "C", 3): {"DA": 1},
    ...
    ("comm. charm +2", "A", 14): {"STR": 9, "AGI": 9, "Magic Damage": 14, "Magic Attack": 4},
    ("compensator", "A", 15): {"DMG": 15, "AGI": 15, "Ranged Attack": 15},
    ("dunna", "A", 15): {"MP": 20, "Magic Accuracy": 10, "Fast Cast": 3},
    ("emissary", "D", 11): {"Magic Accuracy": 11, "Magic Attack": 16},
    ...
    ("lathi", "C", 15): {"INT": 15, "Magic Attack": 15, "Magic Accuracy": 15},
    ("nibiru harp", "D", 15): {"Magic Evasion": 20, "PDT": -3, "MDT": -3},
    ("nibiru cudgel", "C", 15): {"MP": 50, "INT": 10, "Magic Attack": 15},
    ("queller rod", "B", 15): {"MND": 15, "Magic Accuracy": 15},
    ("queller rod", "D", 15): {"Healing Magic Skill": 15, "Cure Potency": 10, "Cure spellcasting time": -7},
    ...
    ("pursuer's doublet", "D", 15): {"HP": 50, "Crit Rate": 4, "Snapshot": 6},
    ("plun. knife", "B", 1): {"FUA": 1, "Subtle Blow II": 1},
    ("pursuer's gaiters", "D", 15): {"Ranged Accuracy": 10, "Rapid Shot": 10, "Recycle": 15},
    ("rawhide vest", "D", 15): {"HP": 50, "Subtle Blow": 7, "TA": 2},
    ("rostam", "A", 16): {"Chance of Double Damage": 32, "Store TP": 16, "DMG": 3},
    ("scout's gorget +1", "A", 3): {"AGI": 3, "Store TP": 1, "PDL": 1},
