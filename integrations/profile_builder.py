...
from engine.create_player import calculate_damage_taken
from engine.equipment_rules import (
    apply_ear_slot_rules, conditional_gear_bonuses, has_conditional_set_effect,
    is_right_ear_only,
)
from integrations.wsdist_bridge import _gear_record, _with_curated_model, _with_ffxiah_model, _exact_rank_augment
